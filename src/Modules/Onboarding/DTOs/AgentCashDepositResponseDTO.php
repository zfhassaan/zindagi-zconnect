...
class AgentCashDepositResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['agentCashDepositRes'])
            && is_array($response['agentCashDepositRes']);
        ...
        $data = $hasWrapper ? $response['agentCashDepositRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Cash deposit successful' : null),
