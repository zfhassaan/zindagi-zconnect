...
class AgentCashWithdrawalResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['agentCashdWithDrawlRes'])
            && is_array($response['agentCashdWithDrawlRes']);
        ...
        $data = $hasWrapper ? $response['agentCashdWithDrawlRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Cash withdrawal successful' : null),
