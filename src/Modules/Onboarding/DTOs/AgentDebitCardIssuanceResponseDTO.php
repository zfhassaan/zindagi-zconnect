...
class AgentDebitCardIssuanceResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['agentDebitCardIssuanceRes'])
            && is_array($response['agentDebitCardIssuanceRes']);
        ...
        $data = $hasWrapper ? $response['agentDebitCardIssuanceRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Debit card issuance successful' : null),
