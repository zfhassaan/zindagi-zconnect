...
class AgentOtpVerificationResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['agentOtpVerificationRes'])
            && is_array($response['agentOtpVerificationRes']);
        ...
        $data = $hasWrapper ? $response['agentOtpVerificationRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'OTP verified successfully' : null),
