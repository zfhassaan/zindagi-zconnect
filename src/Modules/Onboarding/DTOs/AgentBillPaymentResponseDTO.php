...
class AgentBillPaymentResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['agentBillPaymentRes'])
            && is_array($response['agentBillPaymentRes']);
        ...
        $data = $hasWrapper ? $response['agentBillPaymentRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Bill payment successful' : null),
