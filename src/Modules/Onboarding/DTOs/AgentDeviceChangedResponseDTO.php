...
class AgentDeviceChangedResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['agentDeviceChangedRes'])
            && is_array($response['agentDeviceChangedRes']);
        ...
        $data = $hasWrapper ? $response['agentDeviceChangedRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Device changed successfully' : null),
