...
class AgentCashWithdrawalInquiryResponseDTO
{
    /**
    ...
    public static function fromApiResponse(array $response): self
    {
        ...
        $hasWrapper = isset($response['agentCashdWithDrawlIinquiryRes'])
            && is_array($response['agentCashdWithDrawlIinquiryRes']);
        ...
        $data = $hasWrapper ? $response['agentCashdWithDrawlIinquiryRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Cash withdrawal inquiry successful' : null),
