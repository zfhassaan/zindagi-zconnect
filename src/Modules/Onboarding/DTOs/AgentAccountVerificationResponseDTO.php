...
class AgentAccountVerificationResponseDTO
{
    /**
    ...
    {
        $hasWrapper = isset($response['accountVerificationAgentRes'])
            && is_array($response['accountVerificationAgentRes']);
        ...
        $data = $hasWrapper ? $response['accountVerificationAgentRes'] : $response;
        ...
        return new self(
            ...
            id: $id,
            errors: $errors,
            message: $firstError['message'] ?? ($success ? 'Account verified successfully' : null),
