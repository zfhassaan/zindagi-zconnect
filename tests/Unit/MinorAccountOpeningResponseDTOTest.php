...
class MinorAccountOpeningResponseDTOTest extends TestCase
{
    public function test_from_api_response_with_camel_case_wrapper(): void
    {
        $dto = MinorAccountOpeningResponseDTO::fromApiResponse([
    ...
    {
        $dto = MinorAccountOpeningResponseDTO::fromArray([
            'minorAccountOpeningRes' => [
                'responseCode' => '00',
                'responseDescription' => 'Successful',
            ],
