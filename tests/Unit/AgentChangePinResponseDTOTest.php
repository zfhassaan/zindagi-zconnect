...
class AgentChangePinResponseDTOTest extends TestCase
{
    public function test_from_api_response_success(): void
    {
        $dto = AgentChangePinResponseDTO::fromApiResponse([
            'agentChangePinRes' => [
                'id' => '99',
                'errors' => [],
            ],
        ...
        $this->assertEquals('PIN changed successfully', $dto->message);
    }
